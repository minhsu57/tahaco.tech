			...
			<div class="content">
				<section >
					...
					<div>
						...
						<div tabindex="0" role="image" style=" margin-bottom: 40px" class="style-ityaylt2" id="comp-ityayn6d" data-reactid=".0.$SITE_ROOT.$desktop_siteRoot.$PAGES_CONTAINER.$centeredContent.$inlineContent.$SITE_PAGES.$mainPage_DESKTOP.$inlineContent.$comp-ityayn6d"><style type="text/css">.style-ityaylt2 svg {width:100%;height:50px;fill:#68B04D;fill-opacity:1;stroke:rgba(237, 21, 102, 1);stroke-width:0px;}
							.style-ityaylt2 svg * {vector-effect:non-scaling-stroke;}
							.style-ityaylt2 a {display:block;height:100%;}</style><svg viewBox="10.494998931884766 78.46100616455078 179.01504516601562 38.894996643066406" role="img" preserveAspectRatio="xMidYMid meet" style="stroke-width: 0px;">
							<g>
				...
				<div class="container">
					<?php foreach ($products as $key => $value) { 
						...
						<div class="col-md-6 col-lg-4 text-center product">
							<a href="<?php echo base_url('category/'.$value->id); ?>"><img class="img-product-home" src="<?php echo $image; ?>" alt="<?php echo $value->name; ?>"></a>
					...
					<div class="grid-container parallax-content section-header-holder" style="opacity: 1;">  
						<div class="mobile-grid-100 tablet-grid-100">
							<header class="parallax-header pt-style-3 ">
								<h2 class="parallax-title"><a ><span><?php echo $website->title; ?></span></a></h2>
							</header>	
						...
						<?php foreach ($news as $new) {
							...
							<div class="item">
								<article class="slide-item">
									<figure class="image-box"><img src="<?php echo $image; ?>" class="img-thumb" alt="<?php echo $new->title; ?>"></figure>
									<div class="info-box">
